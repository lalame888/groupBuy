  ...
  return (
    ...
    >
      ...
      <div style={sideBarStyle}>
        ...
        >
          <span style={{ letterSpacing: '30px', marginLeft: '30px' }}>
            訂單內容
          </span>
        </div>
        <div style={{ padding: '30px 20px', fontSize: '16px' }}>
          <div
            style={{
              ...
              boxShadow: 'inset 0px 0px 3px 1px #80808042',
              overflow: 'auto',
            }}
          >
            {myOrder.orderList.map((goods, index) => {
              return (
                <EditGoodsCard
                  ...
                  goods={goods}
                  key={`${goods.uid}-${index}}`}
                  editGoods={(newGoods: GoodsData) => {
                    editGoods(newGoods, index);
                  }}
                  delete={() => {
                    deleteGoods(index);
                  }}
            ...
            {setting.addNote && (
              <>
                ...
                <textarea
                  ...
                  value={orderNote}
                  onChange={(event) => {
                    setOrderNode(event.target.value);
                  }}
                />
              </>
            )}
