...
export class StoreObject extends DataSetter<StoreObject, StoreData> {
  constructor(data?: Partial<StoreData>) {
  ...
  // getter
  get name() {
    return this.dataGetter('name') as string;
  }
  get phone() {
    return this.dataGetter('phone') as string;
  }
  get address() {
    return this.dataGetter('address') as string;
  }
  get coverImage() {
    return this.dataGetter('coverImage') as string;
  }
  get menuImage() {
    return this.dataGetter('menuImage') as Array<string>;
  }
  get menuData(): Array<MenuData> | undefined {
    return this.dataGetter('menuData') as Array<MenuData>;
  }
  get editable(): boolean {
    const setting = this.dataGetter('setting') as StoreSetting;
  ...
  get nowIsBusinessHours(): boolean | undefined {
    // 取得目前是否營業中: 是/否/無資料
    const now = new Date();
